import { BillDTO, BillStatus } from "../../../dto/bill_dto"
import { PaymentDTO } from "../../../dto/payment_dto"

export const bills: BillDTO[] = [
  { id: 1, customerName: "Rodriguez Family", meterNumber: "OW1234", previousReading: 1250, currentReading: 1777,consumption: 25, amount: 385.50, dueDate: "2024-02-15", status: "paid", paidDate: "2024-02-10" },
...
export const paymentHistory: PaymentDTO[] = [

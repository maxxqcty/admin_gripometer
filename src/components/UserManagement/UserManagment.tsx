...
import { useUserManagementData } from "./data"; // ✅ bridge import
...
export function UserManagement() {
  ...
  const { meterReaders, customers, loading, error } = useUserManagementData();
            ...
            <CardHeader className="pb-4 flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-base">
                  Manage field agents responsible for collecting water meter readings
                </CardDescription>
              </div>

...
const notifications = [
	{
		id: 1,
		title: "New Billing Alert",
		description: "Customer Juan paid their bill.",
	},
	{id: 2, title: "System Update", description: "Database backup completed."},
	{id: 3, title: "System Update", description: "Database backup completed."},
];
					...
					<SidebarContent className="px-3 py-4">
						...
						<div className="mt-8 px-1">
							<div className="bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 p-5 rounded-xl shadow-sm">
								...
								<Badge className="bg-green-100 text-green-800 hover:bg-green-100 mb-3 font-medium">
						...
						<div className="flex items-center justify-between">
							...
							<div className="flex items-center space-x-6">
								<Button
									variant="outline"
									size="default"
									className="border-primary/30 hover:bg-primary/5 hover:border-primary/50 shadow-sm"
									onClick={() => setIsNotifOpen(true)}
								>
									<Bell className="h-4 w-4 mr-2" />
									Notifications
									<Badge className="ml-3 bg-destructive/10 text-destructive hover:bg-destructive/10 font-semibold">
										3
									</Badge>
								</Button>
